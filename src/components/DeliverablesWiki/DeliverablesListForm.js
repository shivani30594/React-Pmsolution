...
import { APP_LOCAL_DATE_FORMAT } from "../../constant";

class DeliverablesListForm extends Component {
  state = {
    formValues: {
      number: "",
      name: "",
  ...
  onSubmit = () => {
    ...
    formValues["due_date"] = formatDate(
      startDate,
      ...
      <React.Fragment>
        <Row>
          <Col lg="3">
            <FormGroup>
              <label>
                Deliverables Number <b className="text-danger">*</b>
              </label>
          ...
          <Col lg="3">
            <FormGroup>
              <label>
                Deliverables Name <b className="text-danger">*</b>
              </label>
          ...
          <Col lg="3">
            <FormGroup>
              <label>
                Deliverables Type <b className="text-danger">*</b>
              </label>
              <Input
                type="select"
                name="type"
...
export default DeliverablesListForm;
